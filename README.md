...
- [wedm](https://github.com/andrewbytecoder/wedm) - WEDM (Wails ETCD Desktop Manager) is a high-performance, cross-platform desktop tool for managing ETCD clusters, featuring a modern and intuitive graphical interface built with Vue 3 and Vuetify.
